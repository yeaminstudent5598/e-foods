...
const ManageOrders = () => {
  ...
  const fetchOrders = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://server-side-ready-food-farm.vercel.app/api/orders');
      if (!response.ok) {
  ...
  const handleStatusChange = async (orderId, newStatus) => {
    try {
        const response = await fetch(`https://server-side-ready-food-farm.vercel.app/api/orders/${orderId}/status`, {
            method: 'PATCH',
