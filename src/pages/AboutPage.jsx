...
const AboutPage = () => {
  return (
    <div className="bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div {...fadeIn}>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                শেকড়ের সন্ধানে <span className="text-green-700">e-foodis</span>
              </h2>
              <div className="space-y-4 text-gray-600 leading-relaxed">
                 <p>
                  শহুরে জীবনের ব্যস্ততায় আমরা অনেকেই হারিয়ে ফেলছি আমাদের গ্রামীণ ঐতিহ্য আর খাঁটি খাবারের স্বাদ। মেশিনের ভিড়ে চাপা পড়ে যাচ্ছে ঢেঁকি ছাঁটা চালের গন্ধ, ঘানিতে ভাঙা তেলের ঝাঁঝ, কিংবা বাড়ির উঠোনে বানানো পিঠার আমেজ। e-foodis-এর জন্ম সেই হারানো স্বাদ ও স্মৃতি ফিরিয়ে আনার একটি আন্তরিক প্রচেষ্টা থেকে।
                </p>
                <p>
                ...
                <p>
                  আমাদের লক্ষ্য শুধু খাঁটি পণ্য বিক্রি করা নয়, বরং শহরের যান্ত্রিক জীবনের সাথে গ্রামের সেই সহজ-সরল, স্নিগ্ধ জীবনধারা আর শত বছরের ঐতিহ্যের একটি সেতুবন্ধন তৈরি করা। প্রতিটি e-foodis পণ্যের সাথে আমরা চেষ্টা করি সেই মাটির গন্ধ আর মানুষের মমতাটুকু আপনার কাছে পৌঁছে দিতে।
                </p>
              </div>
            </motion.div>
          </div>
      ...
      {/* ===== Rural Traditions Section (অপরিবর্তিত) ===== */}
      <section className="py-16 md:py-24 bg-green-50"> 
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* ঢেঁকি ছাঁটা চাল */}
            <motion.div 
              className="bg-white p-8 rounded-lg shadow-lg text-center border-b-4 border-yellow-600"
              {...fadeIn} transition={{ duration: 0.7, ease: "easeOut", delay: 0.1 }}
            >
            ...
            {/* ঘানিতে ভাঙা তেল */}
            <motion.div 
              className="bg-white p-8 rounded-lg shadow-lg text-center border-b-4 border-orange-600"
              {...fadeIn} transition={{ duration: 0.7, ease: "easeOut", delay: 0.2 }}
            >
            ...
            {/* হাতে গড়া মমতা */}
            <motion.div 
              className="bg-white p-8 rounded-lg shadow-lg text-center border-b-4 border-red-600"
              {...fadeIn} transition={{ duration: 0.7, ease: "easeOut", delay: 0.3 }}
            >
      ...
      {/* ======================================================= */}
      {/* ===== নতুন সেকশন: কৃষক ও কারিগরদের সাথে পরিচিতি ===== */}
      {/* ======================================================= */}
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <motion.div className="text-center mb-16" {...fadeIn}>
            ...
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
              তাদের শ্রম আর সততাই e-foodis-এর শক্তি। পরিচয় করিয়ে দিচ্ছি আমাদের কয়েকজন কৃষক ও কারিগরের সাথে।
            </p>
          </motion.div>

          {/* === Farmer/Artisan Grid === */}
          {/* TODO: এখানে আসল ছবি ও তথ্য ব্যবহার করুন */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            >
              <img 
                src="https://i.ibb.co.com/QvJDsG8y/Textbook-Travel-Currently-Exploring-The-Animal-Kingdom.jpg" // Placeholder
                alt="কারিগর ১" 
                className="w-36 h-36 rounded-full object-cover mb-4 border-4 border-green-200 shadow-md" 
              />
              <h3 className="text-xl font-semibold text-gray-800">রহিমা বেগম</h3>
              <p className="text-gray-500 text-sm">গ্রাম: চাঁদপুর</p>
              <p className="mt-2 text-green-700 font-medium">পণ্য: হাতে ভাজা মুড়ি ও চালের গুঁড়া</p>
              <p className="mt-3 text-gray-600 italic text-sm">
                "নিজের হাতে তৈরি করি, যেমন নিজের ঘরের জন্য বানাই। কোনো ভেজাল নাই।"
              </p>
            </motion.div>
            ...
            >
              <img 
                src="https://i.ibb.co.com/Dgj5tt94/Download-premium-image-of-Indian-farmer-doing-agriculture-vegetable-smiling-plant-about-indian-farme.jpg" // Placeholder
                alt="কারিগর ২" 
                className="w-36 h-36 rounded-full object-cover mb-4 border-4 border-green-200 shadow-md" 
              />
              <h3 className="text-xl font-semibold text-gray-800">আব্দুল খালেক</h3>
              <p className="text-gray-500 text-sm">গ্রাম: নওগাঁ</p>
              <p className="mt-2 text-green-700 font-medium">পণ্য: অর্গানিক হলুদ ও মরিচের গুঁড়া</p>
              <p className="mt-3 text-gray-600 italic text-sm">
                "জমিতে কোনো সার-বিষ দেই না। যা হয়, আল্লার রহমতে ভালোই হয়।"
              </p>
            </motion.div>
            ...
            >
              <img 
                src="https://images.stockcake.com/public/f/0/2/f02a71da-9a50-4e0e-bd4d-0db5dd5b140c_medium/traditional-cooking-scene-stockcake.jpg" // Placeholder
                alt="কারিগর ৩" 
                className="w-36 h-36 rounded-full object-cover mb-4 border-4 border-green-200 shadow-md" 
              />
              <h3 className="text-xl font-semibold text-gray-800">ফরিদা ইয়াসমিন</h3>
              <p className="text-gray-500 text-sm">গ্রাম: বিক্রমপুর</p>
              <p className="mt-2 text-green-700 font-medium">পণ্য: বিভিন্ন প্রকার আচার</p>
              <p className="mt-3 text-gray-600 italic text-sm">
                "শাশুড়ির কাছ থেকে শেখা রেসিপি। যত্ন করে বানাই, সবাই খুব পছন্দ করে।"
              </p>
            </motion.div>
          </div>
        </div>
      ...
      {/* ===== Meet Our Team Section (অপরিবর্তিত) ===== */}
      <section className="py-16 md:py-24 bg-gray-50"> {/* ব্যাকগ্রাউন্ড পরিবর্তন */}
        <div className="container mx-auto px-4">
          <motion.div className="text-center mb-16" {...fadeIn}>
 ...
 <motion.div 
            ...
            >
              <div className="relative inline-block">
                <img 
                  src="https://scontent.fdac24-5.fna.fbcdn.net/v/t39.30808-6/509432432_1977168029754058_6770209236524440672_n.jpg?_nc_cat=102&ccb=1-7&_nc_sid=a5f93a&_nc_eui2=AeEPeGWJzJS1LznRTfMl5Oh2xdc-8fK24ozF1z7x8rbijLC5NB5EDA3wtdCiSbgo4UfDxW7m_mk92djTm86b4H66&_nc_ohc=DAFnm5VlE-sQ7kNvwGHEj2T&_nc_oc=AdmlGiBiHaDuUCkKg_Te1rZuCezk5ykWlus2rYPgKXG9LWOuB9v83kCxVYEf8rO7X7w&_nc_zt=23&_nc_ht=scontent.fdac24-5.fna&_nc_gid=JgKXwS6uW386hSC2DRr_bA&oh=00_Afd4010Cy0ZpeMdZxNvmoaM_wXBFcSehcTBGnnLSRHmQLg&oe=68FD5151" // Placeholder Image
                  alt="Team Member 1" 
                  className="w-48 h-48 rounded-full object-cover mx-auto mb-4 border-4 border-gray-200 group-hover:border-green-500 transition-colors" 
                />
                {/* Optional: Social Links Icon */}
              </div>
              <h3 className="text-xl font-semibold text-gray-800">ইয়ামিন মাদবর</h3>
              <p className="text-green-700 font-medium">পদবী ( প্রতিষ্ঠাতা)</p>
            </motion.div>
            {/* Team Member 2 */}
            <motion.div 
              className="text-center group"
            ...
            >
               <div className="relative inline-block">
                <img src="https://scontent.fdac24-1.fna.fbcdn.net/v/t39.30808-6/484817937_2113263422438620_2586234141452055034_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=a5f93a&_nc_eui2=AeGB_nwBDRQTXcbxINdE3TVmZptpu9VBLixmm2m71UEuLBNCQMGZp1jSYRlCnNh5vu5iV3_HQTUWE-xLAzi--Pae&_nc_ohc=xe25GgLe6x0Q7kNvwHJ1o0i&_nc_oc=AdlruXah-I0zKTbFyJ3bSLwdAJsbx-Q4GPTeBdcqP5wUDeAElRrdtp3HuNhTchjc1E8&_nc_zt=23&_nc_ht=scontent.fdac24-1.fna&_nc_gid=AU0yh1dl3C2EMs-ejMjXBA&oh=00_AffXFWMwCCGmZwOUwMQs47UHKoFaxHI1re6c3ZwbfvRaaA&oe=68FD3176" alt="Team Member 2" className="w-48 h-48 rounded-full object-cover mx-auto mb-4 border-4 border-gray-200 group-hover:border-green-500 transition-colors" />
               </div>
              <h3 className="text-xl font-semibold text-gray-800">মোঃ মিজান</h3>
              <p className="text-green-700 font-medium"> (সংগ্রহকারী)</p>
            </motion.div>
            {/* Team Member 3 */}
            <motion.div 
              className="text-center group"
            ...
            >
               <div className="relative inline-block">
                <img src="https://scontent.fdac24-2.fna.fbcdn.net/v/t39.30808-6/481899771_1013994870595916_9149949265966877033_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=a5f93a&_nc_eui2=AeGOX4QOfOAP45rF71eI_azjnpdZErGj-U2el1kSsaP5TdgovHC30fCz5RhlTwKDvKvftJiENjd9JE-cBKrXn9X6&_nc_ohc=e7hcAN_eXhYQ7kNvwE-uqXb&_nc_oc=AdkfDzx2RIXMrD35bziysX2jrsUDa8lnaLboOt-9GH6nD7PiLtz71jTtgFm60sNe7Wo&_nc_zt=23&_nc_ht=scontent.fdac24-2.fna&_nc_gid=XlAcjtIhrAQbYsheVhwMYQ&oh=00_AfeThw0aVX_jGGX0CfYTDhYgQ-5DCR42-8u8psYWbjXkhg&oe=68FD4A94" alt="Team Member 3" className="w-48 h-48 rounded-full object-cover mx-auto mb-4 border-4 border-gray-200 group-hover:border-green-500 transition-colors" />
               </div>
              <h3 className="text-xl font-semibold text-gray-800">ইউসুফ রহমান</h3>
              <p className="text-green-700 font-medium">পদবী (মান নিয়ন্ত্রণ)</p>
            </motion.div>
            {/* Team Member 4 */}
            <motion.div 
              className="text-center group"
            ...
            >
               <div className="relative inline-block">
                <img src="https://scontent.fdac24-2.fna.fbcdn.net/v/t39.30808-6/481006126_1342102890576039_7977481923929653239_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=a5f93a&_nc_eui2=AeGiC-FJssUp3h7xlptgpkNOOIX5vJ6luyo4hfm8nqW7Kml56M8INR13qHTdUwLj7VwWHTNMHLLGK9hbzXydxH0d&_nc_ohc=CuRhWpHtJ0QQ7kNvwGMaGIR&_nc_oc=AdmL8cWoHSoq8S1P401Wj0IGB6i4AMj9KNxW-G8ynbZAD3KM-0x5BmbQFZEcg_1wQMI&_nc_zt=23&_nc_ht=scontent.fdac24-2.fna&_nc_gid=Ektv3e9YkZGaW12z_Z3j3A&oh=00_Afep7Bup4au2xsiHX2CkWpCTp-mBs9wHx76-DaTxnm6b_w&oe=68FD3069" alt="Team Member 4" className="w-48 h-48 rounded-full object-cover mx-auto mb-4 border-4 border-gray-200 group-hover:border-green-500 transition-colors" />
               </div>
              <h3 className="text-xl font-semibold text-gray-800">মাহমুদুল এইচ মারুফ</h3>
              <p className="text-green-700 font-medium">পদবী (ডেলিভারি সমন্বয়ক)</p>
            </motion.div>
          </div>
        </div>
      </section>

      {/* ===== Our Values Section (অপরিবর্তিত) ===== */}
      <section className="py-16 md:py-24 bg-white"> {/* ব্যাকগ্রাউন্ড পরিবর্তন */}
        <div className="container mx-auto px-4">
          <motion.div className="text-center mb-16" {...fadeIn}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {ourValues.map((item, index) => (
              <motion.div 
                key={index}
                className="bg-gray-50 p-6 rounded-lg shadow-lg text-center border-t-4 border-green-600" // ব্যাকগ্রাউন্ড পরিবর্তন
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
